...
const DentalVeneersPage = ({ onNavigate }: TreatmentPageProps) => {
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-5xl font-bold text-gray-900 mb-6">Dental Veneers</h1>
              <p className="text-2xl font-bold text-mint mb-6">From ₹8,000</p>
              <p className="text-xl text-gray-600 leading-relaxed mb-8">
                Ultra-thin, custom-made porcelain shells that are bonded to the front surface of teeth to create a beautiful, natural-looking smile transformation.
              </p>
            ...
            <div>
              <img 
                src="/dental-veneers-NYC-before-after.jpg" 
      ...
      <div className="py-16">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-16">
            <h2 className="text-3xl font-bold text-gray-900 mb-6">What are Dental Veneers?</h2>
            <p className="text-lg text-gray-600 leading-relaxed mb-6">
              Dental veneers are wafer-thin shells of tooth-colored porcelain that are custom-made to cover the front surface of teeth. They are designed to improve the appearance of teeth that are discolored, worn down, chipped, misaligned, or have gaps between them.
            </p>
            <p className="text-lg text-gray-600 leading-relaxed">
              Made from high-quality dental porcelain, veneers mimic the natural translucency and color of tooth enamel, providing stunning, long-lasting results. They can dramatically transform your smile in just 2-3 visits while preserving most of your natural tooth structure.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-16">
            ...
            <div className="bg-mint/5 p-6 rounded-2xl text-center">
              ...
              <p className="text-gray-600">2-3 visits over 2-3 weeks</p>
            </div>
            <div className="bg-mint/5 p-6 rounded-2xl text-center">
          ...
          {/* Benefits */}
          <div className="mb-16">
            <h2 className="text-3xl font-bold text-gray-900 mb-8">Benefits of Dental Veneers</h2>
            <div className="grid md:grid-cols-2 gap-6">
              {[
                ...
                'Stronger than natural tooth enamel'
              ].map((benefit, index) => (
          ...
          <div className="bg-gradient-to-r from-mint/10 to-mint/5 rounded-2xl p-12 text-center">
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
              Transform your smile with custom porcelain veneers. Get the Hollywood smile you've always wanted in just a few visits.
            </p>
