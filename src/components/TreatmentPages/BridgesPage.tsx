...
const BridgesPage = ({ onNavigate }: TreatmentPageProps) => {
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-5xl font-bold text-gray-900 mb-6">Dental Bridges</h1>
              <p className="text-2xl font-bold text-mint mb-6">From ₹8,000</p>
              <p className="text-xl text-gray-600 leading-relaxed mb-8">
                Custom dental bridges that replace missing teeth by anchoring to adjacent teeth, restoring your smile's function and appearance.
              </p>
      ...
      <div className="py-16">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-16">
            <h2 className="text-3xl font-bold text-gray-900 mb-6">What are Dental Bridges?</h2>
            <p className="text-lg text-gray-600 leading-relaxed mb-6">
              Dental bridges are fixed prosthetic devices that replace one or more missing teeth by anchoring to the natural teeth or implants on either side of the gap. They literally "bridge" the space where teeth are missing.
            </p>
            <p className="text-lg text-gray-600 leading-relaxed">
              Made from porcelain, ceramic, or metal alloys, bridges restore your ability to chew and speak properly while maintaining the shape of your face and preventing remaining teeth from shifting out of position.
            </p>
          </div>
          ...
          <div className="mb-16">
            ...
            <div className="space-y-4">
              {[
                ...
                'Preparation of anchor teeth (abutments) on either side',
                'Precise impressions or digital scans of prepared teeth',
                'Temporary bridge placed for protection and function',
                'Custom bridge fabricated in specialized laboratory',
                'Careful fitting and adjustment for perfect bite alignment',
                'Permanent cementation and final bite verification'
              ].map((step, index) => (
          ...
          {/* Benefits */}
          <div className="mb-16">
            <h2 className="text-3xl font-bold text-gray-900 mb-8">Benefits of Dental Bridges</h2>
            <div className="grid md:grid-cols-2 gap-6">
              {[
                'Restores ability to chew and speak properly',
                'Maintains facial shape and prevents sagging',
                'Prevents remaining teeth from shifting position',
                'Fixed solution that cannot be removed',
                'Natural appearance that blends with existing teeth',
                'More affordable than multiple implants',
                'Proven long-term success with proper care',
                'Immediate restoration of smile confidence'
              ].map((benefit, index) => (
          ...
          <div className="bg-gradient-to-r from-mint/10 to-mint/5 rounded-2xl p-12 text-center">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Bridge the Gap in Your Smile</h2>
            <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
              Replace missing teeth with our custom dental bridges and restore your smile's function and beauty. Get back to eating and speaking with confidence.
            </p>
