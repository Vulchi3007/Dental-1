...
const GumContouringPage = ({ onNavigate }: TreatmentPageProps) => {
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-5xl font-bold text-gray-900 mb-6">Gum Contouring</h1>
              <p className="text-2xl font-bold text-mint mb-6">From ₹10,000</p>
              <p className="text-xl text-gray-600 leading-relaxed mb-8">
                Laser gum reshaping to create the perfect gum line, enhancing your smile's proportions and revealing more of your beautiful teeth.
              </p>
            ...
            <div>
              <img 
                src="/Gum Treatment.jpeg" 
                alt="Gum Contouring Treatment"
      ...
      <div className="py-16">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-16">
            <h2 className="text-3xl font-bold text-gray-900 mb-6">What is Gum Contouring?</h2>
            <p className="text-lg text-gray-600 leading-relaxed mb-6">
              Gum contouring, also known as gum reshaping or gingivoplasty, is a cosmetic dental procedure that reshapes the gum line to improve the appearance of your smile. It's ideal for people with a "gummy smile" or uneven gum lines.
            </p>
            <p className="text-lg text-gray-600 leading-relaxed">
              Using advanced laser technology, we can precisely remove excess gum tissue or reshape the gum line to create better proportions between your teeth and gums, resulting in a more balanced and attractive smile.
            </p>
          </div>
          ...
          <div className="mb-16">
            ...
            <div className="space-y-4">
              {[
                'Comprehensive gum and smile analysis with digital imaging',
                'Local anesthesia applied for patient comfort',
                'Precise marking of new gum line design',
                'Advanced laser technology used to reshape gum tissue',
                'Careful contouring to achieve optimal proportions',
                'Immediate hemostasis and tissue sealing with laser',
          ...
          {/* Benefits */}
          <div className="mb-16">
            <h2 className="text-3xl font-bold text-gray-900 mb-8">Benefits of Gum Contouring</h2>
            <div className="grid md:grid-cols-2 gap-6">
              {[
                'Creates perfect gum line symmetry and balance',
                ...
                'Immediate visible improvement in smile aesthetics',
          ...
          <div className="bg-gradient-to-r from-mint/10 to-mint/5 rounded-2xl p-12 text-center">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Perfect Your Gum Line Today</h2>
            <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
              Transform your gummy smile into a perfectly balanced, confident smile with our advanced laser gum contouring procedure.
            </p>
